      ...
      <div class="col-md-6" style="padding: 20px;">
        ...
        <div class="mb-3">
          ...
          >
            ...
            <option value="1" {{ old('batch_status', $batch->batch_status) == 1 ? 'selected' : '' }}>On Going</option>
            <option value="0" {{ old('batch_status', $batch->batch_status) == 0 ? 'selected' : '' }}>Completed</option>
          </select>
